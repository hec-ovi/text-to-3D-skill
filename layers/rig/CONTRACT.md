...
- The skeleton is **measured, not templated**. The mesh is sliced along its up axis; where a slice splits into two islands the legs begin, and the widest band in the upper half is the shoulder line. A stocky figure and a tall one get different bones from the same code.
